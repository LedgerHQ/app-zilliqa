...
static unsigned char const C_cx_secp256k1_h = 1;
...
void zil_ecschnorr_sign_init(zil_ecschnorr_t *T,
  ...
  //  3. Compute the challenge r = H(Q, kpub, m) [CME: mod n according to
  //  pdf/code, Q and kpub compressed "02|03 x" according to code)
  ...
  os_memmove(R + 1, U.Q + 1, size),
      cx_ecfp_generate_pair2(domain->curve, &U.pub_key,
                             (cx_ecfp_private_key_t *)pv_key, 1, CX_NONE);
...
void zil_ecschnorr_sign_continue(zil_ecschnorr_t *T, const unsigned char *msg,
...
int zil_ecschnorr_sign_finish(zil_ecschnorr_t *T,
                              const cx_ecfp_private_key_t *pv_key,
