...
// instructs it to run various commands. The Zilliqa app supports three
// commands, each defined in a separate file: getVersion, getPublicKey and
// signTxn. These each make use of Zilliqa-specific functions, which are defined
// in zilliqa.c. Finally, some global variables and helper functions are
// declared in ux.h.
//
...
// - the main loop invokes command handlers, which display screens and set
// button handlers
